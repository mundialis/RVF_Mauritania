...
| 05 | 02 <br/> (presence samples: 132, All samples: 437) | single model with 09/10 2020 and 09/10 2022 data combined (the four month with the most positive disease data) | variable contribution: 30 % lst night, 30 % current month precipitation <br/> application results has a lot of round/circle structures with strong borders of change in risk (coming from precipitation) |
...
| 07 | 02 <br/> (presence samples: 232, All samples: 487)| as mv05, but keep duplicates during training | precipitation 2 month earlier strongest impact on model (ca. 50 %) <br/> similar geometric patterns (coming from precipitation) as in mv05|
